    ...
    <section>
      <VideoHeroSection>
        <div className="flex flex-col justify-center items-center h-screen ">
          ...
          <p className=" text-yellow-500 mb-16">
            Text to mathematical graphical video generator
          </p>
          <div className="bg-[#170f02ce] relative backdrop-blur-sm text-yellow-400 text-md h-36 w-[500px] px-5 pt-4 rounded-xl border-[#402a06] border-2">
            <textarea
              name=""
              id=""
