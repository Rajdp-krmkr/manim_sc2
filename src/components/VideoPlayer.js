    ...
    <div className="video-player-container">
      ...
      <div className="video-list">
        ...
        {!loading && videos.length === 0 && !error && (
          <div className="no-videos">
            No videos found. Make sure your server is running and has videos in
            the /video directory.
          </div>
        )}
          ...
          >
            <div className="video-info">
              ...
              <div className="video-details">
                Size: {formatFileSize(video.size)} | Modified:{" "}
            ...
            <div className="video-actions">
              ...
              <button
                ...
                onClick={() =>
                  window.open(
                    `${apiUrl}/download/${encodeURIComponent(video.name)}`,
                    "_blank"
                  )
                }
              >
